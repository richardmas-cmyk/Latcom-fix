...
const LATCOM_PRODUCTS = {
    ...
    fixedTopups: [
        { productId: "XOOM_010_MXN", skuId: "0", amount: 10, currency: "MXN", service: 2, description: "Tiempo aire 10 pesos" },
        { productId: "XOOM_020_MXN", skuId: "0", amount: 20, currency: "MXN", service: 2, description: "Tiempo aire 20 pesos" },
        { productId: "XOOM_030_MXN", skuId: "0", amount: 30, currency: "MXN", service: 2, description: "Tiempo aire 30 pesos" },
        { productId: "XOOM_040_MXN", skuId: "0", amount: 40, currency: "MXN", service: 2, description: "Tiempo aire 40 pesos" },
        { productId: "XOOM_050_MXN", skuId: "0", amount: 50, currency: "MXN", service: 2, description: "Tiempo aire 50 pesos" },
        { productId: "XOOM_060_MXN", skuId: "0", amount: 60, currency: "MXN", service: 2, description: "Tiempo aire 60 pesos" },
        { productId: "XOOM_070_MXN", skuId: "0", amount: 70, currency: "MXN", service: 2, description: "Tiempo aire 70 pesos" },
        { productId: "XOOM_080_MXN", skuId: "0", amount: 80, currency: "MXN", service: 2, description: "Tiempo aire 80 pesos" },
        { productId: "XOOM_090_MXN", skuId: "0", amount: 90, currency: "MXN", service: 2, description: "Tiempo aire 90 pesos" },
